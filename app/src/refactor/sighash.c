...
const uint8_t CONSENSUS_BRANCH_ID_NU6_1[4] = {0xF0, 0x4D, 0xEC, 0x4D};      // nu6.1
const uint8_t CONSENSUS_BRANCH_ID_NU6_2[4] = {0x30, 0xF3, 0x37, 0x54};    // nu6.2
const uint8_t CONSENSUS_BRANCH_ID_NU6_3[4] = {0x5B, 0x16, 0xA5, 0x37};    // nu6.3
...
static zxerr_t signature_hash_v4(const uint8_t *input, uint16_t inputlen, uint8_t *output) {
    ...
    MEMCPY(personalization + 12, CONSENSUS_BRANCH_ID_NU6_3, 4);
